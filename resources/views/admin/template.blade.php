...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ URL::asset('img/logo.png')}}">
    <!-- Custom CSS -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{$menu == 'dashboard' ? '':URL::route('dashboard');}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span
                                    class="hide-menu">Dashboard</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{$menu == 'siswa' ? '':URL::route('data-siswa');}}" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span
                                    class="hide-menu">Data Siswa</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{$menu == 'ekstra' ? '': URL::route('data-ekstra');}}" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span
                                    class="hide-menu">Data Ekstrakulikuler</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span
                                    class="hide-menu">Analisis</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{$menu == 'kriteria' ? '':URL::route('data-kriteria');}}" class="sidebar-link"><i
                                            class="mdi mdi-note-outline"></i><span class="hide-menu"> Kriteria
                                        </span></a></li>
                                <li class="sidebar-item"><a href="{{$menu == 'pertanyaan' ? '': URL::route('pertanyaan');}}" class="sidebar-link"><i
                                            class="mdi mdi-note-plus"></i><span class="hide-menu"> Pertanyaan
                                        </span></a></li>
                                <li class="sidebar-item"><a href="{{$menu == 'proses' ? '': URL::route('proses');}}" class="sidebar-link"><i
                                    class="mdi mdi-note-plus"></i><span class="hide-menu"> Proses Analisis
                                </span></a></li>
                            </ul>
                        </li>
                        {{-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="widgets.html" aria-expanded="false"><i class="mdi mdi-account"></i><span
