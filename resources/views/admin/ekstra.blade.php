...
<div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Data Ekstrakulikuler</h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Data Ekstrakulikuler</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Tabel Ekstrakulikuler</h5>
                        ...
                        {{-- form tambah --}}
                        <div class="card">
                            <form method="post" action="{{URL::route('proses-tambah-ekstra')}}">
                                @csrf
                                <div class="card-body">
                                    <h5 class="card-title">Form</h5>
                                        <div class="form-group row">
                                            <label for="nama"
                                                class="col-sm-3 text-end control-label col-form-label">Nama Ekstrakulikuler</label>
                                            <div class="col-sm-9">
